...
**子任务**:
- [ ] H1: 首页卡片添加点击跳转 (策略→/strategies, 行情→/stocks)
- [ ] D2: 股票池详情股票列表添加跳转到股票详情
- [ ] D3: 股票池详情添加股票搜索功能
- [ ] G1: 修复 /settings 页面白屏 (添加页面或移除入口)
- [ ] G2: 修复 /profile 页面白屏 (添加页面或移除入口)
...
**子任务**:
- [ ] F1: 优化"初始化内置因子"按钮提示
- [ ] F2: 为每个内置因子添加详细描述 (定义、计算方式、使用场景)
- [ ] S1: 简化策略状态设计或添加状态流转说明
- [ ] S2: 为每个内置策略添加详细描述 (原理、参数含义、适用场景)
...
**子任务**:
- [ ] D1: 调整 Tab 顺序 (股票池 → 股票列表)
- [ ] D4: 改造股票选择组件 (支持代码/名称模糊搜索)
- [ ] D5: 股票列表添加股票池筛选器
